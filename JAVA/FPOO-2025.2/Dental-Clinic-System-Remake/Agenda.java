...
public class Agenda {
	...
	//métodos
	public void colocaHorarioConsultaAgenda(Consulta consulta) {
	...
	public void removerHorarioConsultaAgenda(int horario_consulta_selecionada) {
		switch(horario_consulta_selecionada) {
			case 8:
				this.hora8 = false;
				break;
			case 9:
